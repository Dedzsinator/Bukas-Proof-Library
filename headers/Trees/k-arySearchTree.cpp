...
public:
    ...
    template <typename U>
    friend std::ostream& operator<<(std::ostream& os, const KarySearchTree<U>& tree) {
        tree.print(tree.root, 0);
        return os;
    }

    template <typename U>
    friend std::istream& operator>>(std::istream& is, KarySearchTree<U>& tree) {
        U data;
        is >> data;
        tree.insert(data);
        return is;
    ...
    template <typename U>
    friend bool operator==(const KarySearchTree<U>& lhs, const KarySearchTree<U>& rhs) {
